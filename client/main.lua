...
function OpenArmoryMenu(station)
  ...
  if Config.EnableArmoryManagement then
    ...
    local elements = {
      ...
      {label = '取出物品',  value = 'get_stock'},
      {label = '存入物品',  value = 'put_stock'}
    }

    if PlayerData.job.grade_name == 'boss' --[[or PlayerData.job.grade_name =='deputy' or PlayerData.job.grade_name =='consigliere']] then
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    --[[ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
		...
		ESX.TriggerServerCallback('esx_vagosjob:getOwnedCars', function(ownedCars)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner', {
			...
			if data.current.value.stored then
				...
				TriggerServerEvent('esx_vagosjob:updatestatus',data.current.value.plate,false)
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'vagos' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
			...
			TriggerServerEvent('esx_vagosjob:updatestatus',vehicleProps.plate,true)
